...
### Download Data 
Source: CoronaWatchNL
The link to the dataset might change. So, please check the github account for more infomration.
...
nl_ds <-
  complete_grid %>% left_join(cities_df %>% select(Datum, City, Aantal) , by =
                                c('Datum', 'City'))#%>%
#
